    ...
    <div id='contact' className='pt-32 container'>
        <div className='grid md:grid-cols-2 gap-10'>
            <div className='space-y-8'>
                ...
                <p className='text-orange-400 text-[18px] pt-2'  data-aos="fade-down">Drop me a line,give me a call,or send me a message by submitting the form</p>
                <div className='flex gap-3 items-center' data-aos="fade-down">
                <MdEmail  size={30}/> ahmedalipathan134@gmail.com
                </div>
